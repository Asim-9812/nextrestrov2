...
class AppColors {
  ...
  // Secondaries
  static const Color secondary = Color(0xFFFE985F);
  static const Color secondaryVariant = Color(0xFFFF782C);
  static const Color secondarySoft = Color(0xFFFFCDB2);
  static const Color secondaryBg = Color(0xFFE7EAF2);

  // Texts
  static const Color textPrimary = Color(0xFF1E1E2D);
  static const Color textSecondary = Color(0xFF666C80);
  static const Color textTertiary = Color(0xFFA5A9B8);
  static const Color textQuaternary = Color(0xFFC8CBD7);
  static const Color textPlaceholder = Color(0xFFE7EAF2);
  static const Color textDisabled = Color(0xFFECEEF4);

  // Backgrounds
  static const Color bgPrimary = Color(0xFFFFFFFF);
  static const Color bgSecondary = Color(0xFFE7EAF2);
  static const Color bgTertiary = Color(0xFFF7F8FC);
  static const Color bgQuaternary = Color(0xFFFAFAFC);
