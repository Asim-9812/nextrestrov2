...
import 'package:nextrestro/features/orders/presentation/pages/landscape/widgets/confirmed/confirmed_orders_landscape_page.dart';
...
import 'package:nextrestro/features/orders/presentation/pages/landscape/widgets/completed/completed_orders_landscape_page.dart';
                  ...
                  children: [
                    Expanded(
                      child: IndexedStack(
                        ...
                        children: [
                          const OrdersDashboardLandscapePage(),
                          const OrdersPlaceOrderLandscapePage(),
                          const ConfirmedOrdersLandscapePage(),
                          const PendingOrdersLandscapePage(),
                          const CompletedOrdersLandscapePage(),
                        ],
                      ),
                    ),
                  ],
