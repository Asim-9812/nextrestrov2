...
class CompletedOrdersPortraitPage extends ConsumerWidget {
  const CompletedOrdersPortraitPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return dashboardAsync.when(
      data: (state) => _buildOrderListSection(context, ref, state.completedOrders),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      leading: Container(
                        ...
                        child: const Icon(Icons.check_circle, size: 20, color: AppColors.success),
                      ),
                      title: Text(
                        'Order #${order.orderID}',
                      ...
                      onTap: () {
                        // Possibly show completed order details or receipt
                      },
                    );
                  },
                ),
