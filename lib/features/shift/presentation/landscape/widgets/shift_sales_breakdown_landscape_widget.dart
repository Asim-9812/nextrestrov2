...
class ShiftSalesBreakdown extends StatelessWidget {
  final ShiftModel shift;
  const ShiftSalesBreakdown({super.key, required this.shift});
...
// Existing _buildSalesRow and _buildDivider methods stay the same
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text('${(percentage * 100).toStringAsFixed(0)}%', style: TextStyle(color: color, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
        ],
      ),
