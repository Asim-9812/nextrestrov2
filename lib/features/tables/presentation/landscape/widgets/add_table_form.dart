...
class AddTableForm extends ConsumerStatefulWidget {
  const AddTableForm({super.key});

  @override
  ConsumerState<AddTableForm> createState() => _AddTableFormState();
}

class _AddTableFormState extends ConsumerState<AddTableForm> {
  ...
  void _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (mounted) {
        ...
        if (state.hasError) {
          Toaster.error(context: context, message: 'Failed to add table: ${state.error}', isLandscape: true);
        } else {
          Toaster.success(context: context, message: 'Table added successfully!', isLandscape: true);
