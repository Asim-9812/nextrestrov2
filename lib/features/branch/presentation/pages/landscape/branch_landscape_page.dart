...
class BranchLandscapePage extends ConsumerStatefulWidget {
  const BranchLandscapePage({super.key});

  @override
  ConsumerState<BranchLandscapePage> createState() => _BranchLandscapePageState();
}

class _BranchLandscapePageState extends ConsumerState<BranchLandscapePage> {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(child: _buildList(filteredBranches)),
                ],
              ),
            ),
          ),
          ...
          Expanded(
            flex: 3,
            child: _buildFormSection(selectedBranch),
          ),
        ],
      ),
    );
  ...
  Widget _buildList(List<BranchModel> list) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final b = list[index];
        final isSelected = ref.watch(selectedBranchForEditProvider)?.branchID == b.branchID;
        ...
        return Card(
          ...
          child: ListTile(
            onTap: () {
              ref.read(selectedBranchForEditProvider.notifier).select(b);
    ...
    if (!isAdding && !isEdit) {
      return const Center(
        child: Column(
          ...
          children: [
            Icon(Icons.store_outlined, size: 64, color: AppColors.ashGrey),
            SizedBox(height: 16),
            Text('Select a branch to view or edit details', 
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(isEdit ? 'Update Branch' : 'Create Branch', 
