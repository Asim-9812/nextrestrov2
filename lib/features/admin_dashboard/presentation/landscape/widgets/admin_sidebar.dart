...
class AdminSidebar extends StatelessWidget {
  ...
  List<Widget> _buildNavItems() {
    final items = [
      ...
      (MaterialSymbols.table_bar, 2, 'Tables'),
      (Bx.food_menu, 3, 'Menu'),
      (MaterialSymbols.schedule, 4, 'Shift Management'),
      (MaterialSymbols.bar_chart, 5, 'Reports'),
      (Ion.ios_people, 6, 'Customers'),
      (Ion.people_circle_sharp, 7, 'Staffs'),
      (MaterialSymbols.store, 8, 'Branch'),
      (MaterialSymbols.account_balance, 9, 'Department'),
    ];
