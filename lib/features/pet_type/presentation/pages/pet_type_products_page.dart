...
class PetTypeProductsPage extends StatefulWidget {
  final PetTypeEntity petType;

  const PetTypeProductsPage({super.key, required this.petType});

  @override
  State<PetTypeProductsPage> createState() => _PetTypeProductsPageState();
}

class _PetTypeProductsPageState extends State<PetTypeProductsPage> {
  final TextEditingController _searchController = TextEditingController();

  @override
  void initState() {
    super.initState();
    context.read<ProductBloc>().add(FilterProductsByPetTypeEvent(widget.petType.id));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '${widget.petType.petTypeName} Items',
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search for ${widget.petType.petTypeName}...',
